...
VECTOR_STORE_ID = "vs_6901a0235f1881918cea7adbd1d6cef1"
...
if "agent" not in st.session_state:
    st.session_state["agent"] = Agent(
        ...
        You have access to the followign tools:
            - Web Search Tool: Use this when the user asks a questions that isn't in your training data. Use this tool when the users asks about current or future events, when you think you don't know the answer, try searching for it in the web first. Please search for at least 3 identical pieces of information and answer.
